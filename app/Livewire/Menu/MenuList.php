    ...
    public function loadMenuItems()
    {
        ...
        $allMenuItems = [
            'breakfast' => [
                [
                    'id' => 1,
                    'image' => asset('menu/breakfast/belgian waffle.jpg'),
                ...
                [
                    'id' => 2,
                    'image' => asset('menu/breakfast/american breakfast.jpg'),
                ...
                [
                    'id' => 3,
                    'image' => asset('menu/breakfast/taco-breakfast-1.jpg'),
                ...
                [
                    'id' => 4,
                    'image' => asset('menu/breakfast/french toast.jpg'),
                    'title' => 'French Toast',
                ...
                [
                    'id' => 5,
                    'image' => asset('menu/breakfast/highland granola.jpg'),
                ...
                [
                    'id' => 6,
                    'image' => asset('menu/breakfast/seasonal fruits.jpg'),
            ...
            'starter' => [
                [
                    'id' => 7,
                    'image' => asset('menu/starter/hiland caesar salad.jpg'),
                ...
                [
                    'id' => 8,
                    'image' => asset('menu/starter/vegetable bowl.jpg'),
                ...
                [
                    'id' => 9,
                    'image' => asset('menu/starter/quinoa bowl.jpg'),
                    'title' => 'Quinoa Bowl',
                ...
                [
                    'id' => 10,
                    'image' => asset('menu/starter/pumpkin spinach salad.jpg'),
                ...
                [
                    'id' => 11,
                    'image' => asset('menu/starter/classic beef tartare.jpg'),
                ...
                [
                    'id' => 12,
                    'image' => asset('menu/starter/coleslaw leaves.jpg'),
            ...
            'soups' => [
                [
                    'id' => 13,
                    'image' => asset('menu/soups/chicken clear soups.jpg'),
            ...
            'main-course' => [
                ...
                [
                    'id' => 15,
                    'image' => asset('menu/main-course/chicken-snitzel.jpg'),
                ...
                [
                    'id' => 16,
                    'image' => asset('menu/main-course/cauliflower gratin.jpg'),
                ...
                [
                    'id' => 18,
                    'image' => asset('menu/main-course/house made posk sausage.jpg'),
                ...
                [
                    'id' => 19,
                    'image' => asset('menu/main-course/seared-barramundi.jpg'),
                ...
                [
                    'id' => 20,
                    'image' => asset('menu/main-course/swedish meetball.jpg'),
                ...
                [
                    'id' => 99,
                    'image' => asset('menu/main-course/fish and chips.jpg'),
            ...
            'desserts' => [
                [
                    'id' => 21,
                    'image' => asset('menu/dessert/coconut tiramisu.jpg'),
                ...
                [
                    'id' => 23,
                    'image' => asset('menu/dessert/warm-apple-pie.jpg'),
                ...
                [
                    'id' => 24,
                    'image' => asset('menu/dessert/spanish churros.jpg'),
                ...
                [
                    'id' => 25,
                    'image' => asset('menu/dessert/mille-fuile.jpg'),
                    'title' => 'Mille Feuille',
