        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            <div class="lg:text-right">
                ...
                <div class="flex gap-4 lg:justify-end">
                    <!-- Google Maps -->
                    <a href="https://maps.app.goo.gl/n9RrjsJLBGFPMCNo6" target="_blank"
                    ...
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/hiland1280/" target="_blank"
                        class="w-12 h-12 border-2 border-white rounded-full flex items-center justify-center hover:bg-[#FFDE68] hover:border-[#FFDE68] hover:text-black transition-all duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
        ...
        <div class="border-t border-gray-800 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p class="text-gray-400 text-sm">
                    &copy; {{ date('Y') }} Hiland1280. All rights reserved.
                </p>
